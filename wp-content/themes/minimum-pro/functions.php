...
//* Add support for custom header, changed width and height from 320 and 60 to 200 and 200
...
function custom_header_inline_logo( $title, $inside, $wrap ) {
	...
	$logo = '<img src="' . get_stylesheet_directory_uri() . '/images/gswga-logo_emblem.png" alt="' . esc_attr( get_bloginfo( 'name' ) ) . '" title="' . esc_attr( get_bloginfo( 'name' ) ) . '" width="200" height="200" />';
